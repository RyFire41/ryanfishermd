...
{
  /* import IconPreviewBoard from "@/components/IconPreviewBoard"; */
}
  ...
  return (
    <div className="min-h-screen text-[#1f2937] bg-[#F4EFE4]">
      ...
      <main
        id="main-content"
        tabIndex={-1}
        className="mx-auto max-w-6xl px-4 py-10 sm:py-14 space-y-10"
      >
        {/* About Section */}
        <section className="rounded-3xl border border-[#E9E5DA] bg-[#FBF9F5] p-8 shadow-sm grid md:grid-cols-3 gap-8 items-start">
          <div className="md:col-span-2">
            ...
            <p className="mt-4 text-[#374151] leading-relaxed text-lg">
              Dr. Ryan M. Fisher is a board-certified Family Medicine physician
              committed to education and the advancement of evidence-based,
              compassionate, and relationship-centered care.
            </p>
            <p className="mt-4 text-[#374151] leading-relaxed text-lg">
              This site serves as a platform for sharing general educational
              materials and insights related to preventive medicine, chronic
              disease management, and whole-person wellness.
            </p>
          </div>
        ...
        <section className="bg-[#F4EFE4]">
          ...
          <div className="mt-4 text-xs leading-5 text-[#374151] space-y-3">
            ...
            <p>
              Use of this website does not create a physician–patient
              relationship with Dr. Ryan M. Fisher.
            </p>
            <p>
        ...
        <p className="text-xs text-[#374151] italic text-center">
          The views and opinions expressed on this site are solely those of Dr.
          Ryan M. Fisher and do not represent the official policy or position of
          the Cleveland Clinic or any affiliated institution.
        </p>

        <p className="text-xs text-[#374151] text-center">
          © {new Date().getFullYear()} Ryan M. Fisher, MD • Educational
